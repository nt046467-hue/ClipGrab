...
export type Platform = "youtube" | "tiktok" | "instagram" | "facebook" | "twitter" | "pinterest" | "unknown"
...
export function PlatformIcon({ platform, className = "w-5 h-5" }: { platform: Platform, className?: string }) {
  switch (platform) {
    ...
    case "pinterest": return <PinterestIcon className={`${className} text-red-600`} />
