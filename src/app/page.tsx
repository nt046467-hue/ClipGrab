  ...
  const startPolling = (jobId: string) => {
    ...
    const interval = setInterval(async () => {
      try {
        ...
        consecutiveErrors++;
        console.warn(`Polling status warning (${consecutiveErrors}/10):`, e);
          ...
          <div className="max-w-3xl mx-auto">
                ...
                <div className="flex flex-col sm:flex-row items-stretch gap-3">
                  <div className="flex-1 flex items-center min-w-0 px-3 sm:px-4">
                    ...
                    <Input
                      ...
                      placeholder="Paste link (YouTube, Pinterest, Instagram, TikTok...)"
            ...
            <div className="mt-5 flex flex-wrap justify-center items-center gap-2 sm:gap-3 text-xs">
              ...
              <button
                ...
                className="px-3 py-1.5 rounded-xl bg-white/[0.02] border border-white/[0.05] hover:bg-white/5 hover:text-red-500 font-semibold text-brand-text-muted transition-all duration-200 focus:ring-2 focus:ring-accent focus:outline-none"
              >
                Pinterest Pin
              </button>
              <button
                ...
                <CardContent className="p-8 sm:p-12 space-y-8 text-center relative">
                  ...
                  <div className="space-y-2">
                    ...
                    <h4 className="font-headline font-black text-2xl sm:text-3xl text-white">
                      ...
                      {downloadingJob.status === 'active' && (downloadingJob.progress >= 99 ? 'Merging & Finalizing File...' : 'Processing Media...')}
                    </h4>
                    <p className="text-brand-text-muted text-xs sm:text-sm">
                      ...
                      {downloadingJob.status === 'active' && (downloadingJob.progress >= 99 ? 'FFmpeg is joining video & audio streams on your disk. Almost done!' : 'Executing extraction. Demuxing stream audio/video.')}
                    </p>
                  </div>
