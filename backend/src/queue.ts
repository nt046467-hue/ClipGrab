...
// Parse host and port for logging
...
// Use Redis if REDIS_URL is explicitly provided as an environment variable.
// Avoids cross-platform issues (e.g. netstat not available on Docker/Render Linux containers).
export const isRedis = !!redisUrl;
